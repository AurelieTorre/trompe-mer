  ...
  return (
    <div className="content">
      <div className="text-detail">
        ...
        <h2 id="skills">Compétences et techniques</h2>
        <p>Trompe-l'œil (huile, acrylique) –  aquarelle –  pastel</p>
        <p>Communication visuelle – graphisme – illustration</p>
        <p>Pinsé (créations à partir de débris ramassés sur la plage)</p>
      </div>
      <h2 id="atelier">Découvrez l’atelier</h2>
      <div className="opus-img">
        <div className="img-strip">
          <img src={Atelier1} alt="atelier avec des bois flottés" />
          <img src={Atelier2} alt="atelier avec des tableaux constitués de cailloux" />
          <img src={Atelier3} alt="atelier avec des cailloux mis en scène" />
          <img src={Atelier4} alt="atelier avec des cadres enchevêtrés" />
        </div>
        <img src={Atelier5} alt="atelier avec des tableaux sur un chevalet" />
      </div>
